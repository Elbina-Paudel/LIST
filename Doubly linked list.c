...
scanf("%d", & value);
printf("0.Enter at begining 1.Enter at end 2.Enter at certain position\n-->");
scanf("%d", & choice);
if (choice == 0) {
insert_begin(value);
} else if (choice == 1) {
...
printf("Input validate choice\n");
return;
}
}
void deletes() {
int choice;
printf("\n 0.Delete at begining 1.Delete at end 2.Delete at position\n-->");
scanf("%d", & choice);
if (choice == 0) {
delete_begin();
} else if (choice == 1) {
